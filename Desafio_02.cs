...
namespace Desafio_02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"A Idade Dos Ubuntus É totaliza em: {IDADE}.");
            Console.WriteLine();


            //T2 - Agrupar os nomes de todos Ubuntus
            Console.WriteLine($"NO total De Ubuntus tem: {nome1}, {nome2} e {nome3}");
            Console.WriteLine();
            ...
            Console.WriteLine($"Em média de IMC dos Ubuntus Eles Tem : {media.ToString("f")}.");
            Console.WriteLine();
            ...
            Console.WriteLine($"Todos os Ubuntos, {EhDev} são Devs");
            Console.WriteLine();
            ...
            Console.WriteLine($"De todos os Ubuntos:{Silva} Tem Silva em seu nome.");
            Console.WriteLine();
